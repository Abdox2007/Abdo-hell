...
def Subscraption():
  ...
  clear()
  r1=requests.get("https://pastebin.com/SJghVa2t").text
  if key1 in r1:
    os.system('clear')
  else:
    os.system("clear")
    print("\\3[1;32m First Get Approvel\3[1;37m ")
    time.sleep(1)
    os.system("clear")
    print ("")
    print(" \3[1;32m RJ Tool Paid You Need Get Approved First\3[1;37m\n")
    print ("")
...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100080915373971')
os.system('xdg-open https://facebook.com/groups/1411421479342832/')
...
logo = """
      .o.            oooooooooo.       oooooooooo.          .oooooo.
     .888.           `888'   `Y8b      `888'   `Y8b        d8P'  `Y8b
    .8"888.           888     888       888      888      888      888
   .8' `888.          888oooo888'       888      888      888      888
  .88ooo8888.         888    `88b       888      888      888      888
 .8'     `888.        888    .88P       888     d88'      `88b    d88'
o88o     o8888o      o888bood8P'       o888bood8P'         `Y8bood8P'
\033[1;92m  
\033[1;93m █
\033[1;94m █
\033[1;95m █
\033[1;96m   
  AUTHOR   :   ABDALHAFU HACKER
  FACEBOOK :   Abdulhadi Al Ghadamsi 
  GITHUB    :   Abdo2007
  LIFE STATUS  :  Abdo-2007
  FRIENDS   : [ Abdul Rahman Al Qarabouli ] 
  TOOL STATUS :  PAID                              
\033[1;91m=========================================================="""
...
def Tabii():
    ...
    print(f"")
    limit = int(input(' EXAMPLE: 1000, 3000, 6000, 10000\n\n PUT CLONING LIMIT: '))
